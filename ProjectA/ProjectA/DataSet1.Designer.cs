...
namespace ProjectA {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public DataTable1Row AddDataTable1Row(int ProjectId, string Title, int AdvisorId, string FirstName, int StudentId) {
...
namespace ProjectA.DataSet1TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        [Group].Id, GroupProject.ProjectId, Project.Title, ProjectAdvisor.AdvisorId, Person.FirstName, GroupStudent.StudentId
FROM            Person INNER JOIN
                         Student ON Person.Id = Student.Id INNER JOIN
                         GroupStudent ON GroupStudent.StudentId = Student.Id INNER JOIN
                         GroupProject ON GroupProject.GroupId = GroupStudent.GroupId INNER JOIN
                         Project ON Project.Id = GroupProject.ProjectId INNER JOIN
                         ProjectAdvisor ON ProjectAdvisor.ProjectId = Project.Id INNER JOIN
                         Advisor ON ProjectAdvisor.AdvisorId = ProjectAdvisor.AdvisorId INNER JOIN
                         Person AS A ON Advisor.Id = A.Id INNER JOIN
                         [Group] ON [Group].Id = GroupStudent.GroupId";
